#!/usr/bin/env python3
"""
Recuperation des codes promo VidaXL depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/vidaxl.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/vidaxl.fr"
STORE_NAME = "VidaXL"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour VidaXL depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-vidaxl)"
    }
    try:
